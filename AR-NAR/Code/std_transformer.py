...
class MyTransformer(nn.Module):
    def __init__(
        self, embedding_size, src_vocab_size, trg_vocab_size, src_pad_idx, num_heads, num_encoder_layers,
...
# german = Field(tokenize=tokenize_ger, lower=True, init_token="<sos>", eos_token="<eos>", fix_length=50)
# english = Field(tokenize=tokenize_eng, lower=True, init_token="<sos>", eos_token="<eos>", fix_length=50)
...
optimizer = optim.Adam(model.parameters(), lr=learning_rate, eps=1e-9, betas=(0.9, 0.98))
